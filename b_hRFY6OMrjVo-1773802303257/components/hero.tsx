      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div>
          ...
          <p className="text-lg text-white/75 leading-relaxed max-w-[520px] mb-10">
            <strong className="text-[#f5c200]">16 anos.</strong> Essa é a idade em que o Brasil confia em você para decidir o futuro do país. Presidentes, governadores, senadores, deputados, prefeitos e vereadores: todos dependem da sua escolha nas urnas.
          </p>
        ...
        <div className="flex flex-col gap-5">
          ...
          {[
            ...
            { icon: "🧑‍🎓", num: "16%", label: "dos eleitores têm até 24 anos", desc: "A cada eleição, mais jovens se alistam pela primeira vez" },
            { icon: "🗺️", num: "5.570", label: "municípios com eleições", desc: "Do Oiapoque ao Chuí, a democracia chega a todo lugar" },
          ].map((stat) => (
            <div 
              key={stat.num}
