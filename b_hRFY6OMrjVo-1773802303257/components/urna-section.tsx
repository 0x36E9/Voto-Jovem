...
const steps = [
  {
    ...
    desc: "Chegue ao local de votacao com documento com foto (RG, CNH, passaporte ou e-Titulo). O mesario vai confirmar sua identidade e liberar a urna."
  },
  {
    num: "2",
    title: "Vereador (5 digitos)",
    desc: "A votacao comeca pelo cargo mais local. Digite o numero do seu candidato a vereador (5 digitos), confira o nome e a foto na tela e pressione CONFIRMA."
  },
  {
    num: "3",
    title: "Prefeito (2 digitos)",
    desc: "Em eleicoes municipais, depois do vereador vem o prefeito (2 digitos). Nas eleicoes gerais, voce vota em deputado estadual (5), deputado federal (4), senador (3), governador (2) e presidente (2)."
  },
  {
    num: "4",
    title: "Use CORRIGE se errar",
    desc: "Se digitar o numero errado antes de confirmar, basta pressionar CORRIGE e digitar novamente. Apos confirmar, nao e possivel alterar o voto."
  },
  {
    num: "5",
    title: "Voto computado e pronto!",
    desc: 'Apos confirmar todos os cargos, a urna emite um sinal sonoro e a tela exibe "VOTO COMPUTADO". Voce votou! O processo inteiro leva menos de 2 minutos.'
  }
]
...
const urnaInfo = [
  {
    ...
    desc: "Os votos sao criptografados antes mesmo de serem armazenados. Impossivel associar um voto ao eleitor."
  },
  {
    icon: "🔍",
    title: "Auditavel por todos os partidos",
    desc: "Partidos politicos, Forcas Armadas, OAB e sociedade civil podem auditar o processo eleitoral completo."
  },
  {
    icon: "⚡",
  ...
  },
  {
    ...
    desc: "Mais de 20 paises ja estudaram o sistema eleitoral brasileiro para implementar em seus territorios."
  }
]
        ...
        <div ref={ref}>
          <div className={`transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-7"}`}>
            ...
            <h2 className="font-[var(--font-heading)] text-[clamp(2.2rem,5vw,3.8rem)] font-black text-white leading-none tracking-tight mb-4">
              Como funciona a <em className="text-[#f5c200] italic">urna eletronica</em>
            </h2>
            <p className="text-lg text-white/70 leading-relaxed max-w-[600px] mb-8">
              A urna eletronica brasileira e referencia mundial em seguranca e eficiencia. Aprenda o passo a passo para votar.
            </p>
          </div>
        ...
        <div className={`transition-all duration-700 delay-200 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-7"}`}>
          <div className="bg-white/[0.06] border-2 border-white/[0.12] rounded-[30px] p-10 flex flex-col gap-4">
            ...
            <div className="bg-[#0a2010] rounded-2xl p-6 border-2 border-[#22a050]/40 font-mono">
              ...
              <div className="text-white/60 text-xs">AGUARDANDO DIGITACAO...</div>
            </div>
