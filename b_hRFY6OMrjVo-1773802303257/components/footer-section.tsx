...
const footerLinks = {
  secoes: [
    { label: "O que e democracia", href: "#democracia" },
    { label: "Tipos de eleicao", href: "#tipos" },
    { label: "Urna eletronica", href: "#urna" },
    { label: "Como escolher candidatos", href: "#candidatos" },
    { label: "Calendario eleitoral", href: "#calendario" }
  ],
  saibaMais: [
    { label: "Titulo eleitoral", href: "#titulo" },
  ...
  tse: [
    ...
    { label: "Urna eletronica", href: "https://www.tse.jus.br/eleicoes/urna-eletronica" }
  ]
}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-white/10 mb-8">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed text-white/50 max-w-[260px]">
            Site educativo e de conscientizacao sobre democracia e participacao politica para jovens brasileiros. Sem fins partidarios ou politico-eleitorais.
          </p>
        </div>
