...
const depoimentos = [
  {
    ...
    quote:
      "Votei pela primeira vez aos 16 anos. A sensação de entrar na cabine e fazer uma escolha que realmente importa é indescritível. Me senti parte de algo maior do que eu.",
  },
  {
    initial: "G",
    ...
    quote:
      "Sempre achei que política não era comigo, mas, quando o transporte da minha cidade piorou, entendi que eu tinha o poder de mudar isso nas urnas. Nunca mais faltei a uma eleição.",
  },
  {
    initial: "M",
    ...
    quote:
      "Minha avó me contou que não pôde votar por anos. Hoje, votar é um ato de respeito à história de luta das mulheres. Em cada eleição, lembro disso e me emociono ao confirmar meu voto.",
  },
]
