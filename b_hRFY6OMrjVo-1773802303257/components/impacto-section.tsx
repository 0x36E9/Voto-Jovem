...
const bentoItems = [
  {
    ...
    desc: "Esse valor, o Fundeb, é decidido pelo governo federal eleito. Mais investimento significa melhores professores, estrutura e materiais para você e para as futuras gerações."
  },
  {
    variant: "amarelo",
    cols: "lg:col-span-2",
  ...
  },
  {
    ...
    desc: "Investimentos em infraestrutura digital, regulação das redes sociais e políticas de inclusão tecnológica são pauta eleitoral — e afetam diretamente você."
  }
]
