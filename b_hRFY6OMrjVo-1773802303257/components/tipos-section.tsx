...
const tipos = [
  ...
  { 
    ...
    icon: "📝", 
    title: "Plebiscito", 
    desc: "Consulta popular em que cidadãos decidem diretamente sobre uma questão política ou social antes da tomada de decisão pelo governo. Um exemplo histórico foi o plebiscito de 1993 sobre monarquia x república no Brasil.",
  ...
  { 
    ...
    icon: "✅", 
    title: "Referendo", 
    desc: "Similar ao plebiscito, mas ocorre após a decisão governamental para aprová-la ou rejeitá-la. Em 2005, o Brasil realizou um referendo sobre o desarmamento, e a maioria votou contra a proibição da venda de armas de fogo.",
    chip: "Confirmação",
    variant: "claro"
  },
  { 
    ...
    <section id="tipos" className="py-24 px-[5%] bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          >
            Tipos de <span className="bg-[#f5c200] px-2 rounded-md">eleição</span>
          </h2>
