const tickerItems = [
  "Voto e poder",
  "Democracia precisa de voce",
  "Alistamento online e gratuito",
  "A urna e segura e rapida",
  "16 anos ja pode votar",
  "Voto facultativo para jovens",
  "Pesquise antes de votar",
  "Seu voto muda a educacao",
  "Seu voto muda a saude",
  "Brasil democratico desde 1988"
]
