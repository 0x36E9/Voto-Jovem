...
const mitos = [
  {
    mito: '"A urna eletronica pode ser fraudada facilmente"',
    verdade: 'A urna eletronica brasileira passa por mais de 30 camadas de seguranca, incluindo criptografia militar, lacres fisicos e auditorias publicas. Desde 1996, nenhuma fraude foi comprovada. O codigo-fonte e aberto para analise de partidos, universidades e entidades como OAB e Forcas Armadas. O Brasil e referencia mundial em seguranca eleitoral.'
  },
  {
    mito: '"Meu voto nao faz diferenca, sao milhoes de pessoas"',
    verdade: 'Eleicoes ja foram decididas por margem minima. Em 2020, pelo menos 17 prefeitos foram eleitos por diferenca de menos de 10 votos. Em 2018, um deputado estadual foi eleito com apenas 1 voto de diferenca. Alem disso, a abstenção enfraquece a legitimidade democratica — quanto menos pessoas votam, menos representativo e o resultado.'
  },
  {
    mito: '"Todos os politicos sao iguais, nao adianta votar"',
    verdade: 'Politicos tem historicos, ideologias e comportamentos muito diferentes. Ha representantes com decadas de trabalho comprovado por suas comunidades. A "todos sao iguais" e uma narrativa que favorece quem nao quer que voce vote e analise criticamente. Pesquise, compare e exija contas. A Lei da Ficha Limpa existe justamente para separar candidatos com historico de crimes dos demais.'
  },
  {
    mito: '"O voto e uma obrigacao chata sem sentido pratico"',
    verdade: 'O voto obrigatorio existe porque sem ele, historicamente, os mais pobres e vulneraveis deixam de votar — seja por desinformacao, seja por pressao. A obrigatoriedade garante uma representatividade mais ampla. Paises com voto voluntario tem abstencao altissima (EUA: 40-60% de abstencao). Votar e uma das formas mais simples de exercer poder real sobre quem governa sua vida.'
  }
]
    ...
    <section id="mitos" className="py-24 px-[5%] bg-[#f7f7f3]">
      <div ref={ref} className={`transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-7"}`}>
        ...
        <p className="text-lg text-[#444440] leading-relaxed max-w-[680px]">
          Desinformacao sobre eleicoes e comum. Veja as fake news mais comuns e entenda a verdade por tras delas.
        </p>
      </div>
