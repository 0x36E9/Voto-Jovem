...
const mitos = [
  ...
  },
  {
    ...
    verdade: 'Políticos têm históricos, ideologias e comportamentos muito diferentes. Há representantes com décadas de trabalho comprovado por suas comunidades. A ideia de que "todos são iguais" é uma narrativa que favorece quem não quer que você vote e analise criticamente. Pesquise, compare e exija prestação de contas. A Lei da Ficha Limpa existe justamente para separar candidatos com histórico de crimes dos demais.'
  },
  {
